...
| `chainId`                | number?   | Chain the universe was deployed on (11155111 Ethereum Sepolia — the only live network; 1 Ethereum Mainnet once contracts ship). Base/Solana chain IDs are reserved for those planned future chains.                         |
