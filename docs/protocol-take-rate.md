...
| 6   | Canon vote (CanonMarketplace) | `CanonMarketplace.sol`                   | **TBD** $LOAR per vote                                                   | 100% burned or treasury (pick one)                        | Choice of burn-vs-treasury is a tokenomics lever — see `tokenomics.md` §Burn                                |
...
- [ ] Lock numbers for all `TBD` rows. Drives the entire `tokenomics.md`
      revenue projection.
- [ ] Decide canon-vote fee destination (burn vs treasury vs split).
