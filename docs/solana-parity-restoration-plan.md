...
| 2026-08-27 | 4b    | ⏳ Deferred (net-new, not a restore): `useChain()` data-layer switch, chain selector UI, `apps/web/src/lib/governance.ts` (OZ Governor ↔ Realms normalization). Its own focused pass.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
