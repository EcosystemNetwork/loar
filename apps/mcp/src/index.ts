...
// ── List Resources ─────────────────────────────────────────────────────
//
// Proxies to server-side `mcp.resources.list`. Agents use this to browse
// the caller's universes, entities, creations, profile, and credits without
// re-invoking billable tools. See docs/prd-mcp-integration.md §5.
