...
export const VIDEO_MODELS: VideoModelConfig[] = [
  ...
  // ── Z.AI / Zhipu — CogVideoX + Vidu ─────────────────────────────────
  {
    id: 'cogvideox-3-t2v',
    provider: 'zai',
    displayName: 'CogVideoX-3',
    shortDescription: 'Z.AI standard text-to-video — inline audio, cinematic motion',
    falModelId: '',
    ...
    isVisibleToUsers: true,
    allowedPlans: [],
    tags: ['standard', 'zai', 'cogvideox', 'audio'],
    bestFor: 'Cinematic text-to-video with optional inline audio track',
  },
  {
    id: 'cogvideox-3-i2v',
    provider: 'zai',
    displayName: 'CogVideoX-3 (image-to-video)',
    shortDescription: 'Z.AI image-conditioned video — preserves source identity',
    falModelId: '',
    zaiModelId: 'cogvideox-3',
    mode: ['image_to_video'],
    qualityTier: 'standard',
    ...
    isVisibleToUsers: true,
    allowedPlans: [],
    tags: ['standard', 'zai', 'cogvideox', 'image-animation'],
    bestFor: 'Animate a still — character + scene identity preserved',
  },
  {
    id: 'vidu-q1',
    provider: 'zai',
    displayName: 'Vidu Q1',
    shortDescription: 'Z.AI fast video — image-to-video with first/last-frame keying',
    falModelId: '',
    zaiModelId: 'vidu-q1',
    ...
    isVisibleToUsers: true,
    allowedPlans: [],
    tags: ['standard', 'zai', 'vidu', 'fast'],
    bestFor: 'Fast keyframe-driven video with first/last frame anchoring',
  },
];
