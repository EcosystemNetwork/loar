...
export const TRANSCRIPTION_MODELS: TranscriptionModelConfig[] = [
  ...
  // ── Google Gemini (multimodal generateContent — segment-level) ────────
  // Gemini has no ASR endpoint; we inline the audio and force structured
  // caption segments via responseSchema. Segment-level timestamps only
  // (no forced-alignment word timings); diarization is prompt-driven.
  {
    id: 'gemini-2-5-flash-transcribe-google',
    provider: 'google',
    displayName: 'Gemini 2.5 Flash (Transcribe)',
    shortDescription: 'Multimodal transcription — 100+ languages, prompt-driven diarization',
    providerModelId: 'gemini-2.5-flash',
    supportsWordTimings: false,
    supportsDiarize: true,
    supportsTranslate: false,
    supportedLanguages: [],
    maxAudioMinutes: 60, // ~18 MB inline ceiling
    qualityTier: 'standard',
    speedTier: 'fast',
    priceTier: 'low',
    providerCostUsdPerMinute: 0.0024, // ~1920 audio tokens/min @ Flash rates
    fiatPriceUsdPerMinute: withFiatMargin(0.0024),
    loarPriceUsdPerMinute: withLoarMargin(0.0024),
    creditCostPerMinute: usdToCredits(withFiatMargin(0.0024)),
    lastVerified: '2026-06-14',
    isEnabled: true,
    isVisibleToUsers: true,
    allowedPlans: [],
    serverPoolAvailable: true,
    tags: ['transcribe', 'google', 'gemini', 'multilingual', 'diarize'],
    bestFor: 'Cheap multilingual transcription with best-effort speaker labels',
  },
  {
    id: 'gemini-2-5-pro-transcribe-google',
    provider: 'google',
    displayName: 'Gemini 2.5 Pro (Transcribe)',
    shortDescription: 'Premium multimodal transcription — best accuracy + diarization',
    ...
    allowedPlans: [],
    serverPoolAvailable: true,
    tags: ['transcribe', 'google', 'gemini', 'multilingual', 'diarize', 'premium'],
    bestFor: 'Highest-accuracy transcription with multi-speaker labels and tricky audio',
  },
  {
    id: 'gemini-2-5-flash-lite-transcribe-google',
    provider: 'google',
    displayName: 'Gemini 2.5 Flash Lite (Transcribe)',
    shortDescription: 'Cheapest Gemini transcription — bulk drafts',
    ...
    speedTier: 'fast',
    priceTier: 'low',
    providerCostUsdPerMinute: 0.0012,
    fiatPriceUsdPerMinute: withFiatMargin(0.0012),
    loarPriceUsdPerMinute: withLoarMargin(0.0012),
    creditCostPerMinute: usdToCredits(withFiatMargin(0.0012)),
    lastVerified: '2026-06-14',
    isEnabled: true,
    isVisibleToUsers: true,
    allowedPlans: [],
    serverPoolAvailable: true,
    tags: ['transcribe', 'google', 'gemini', 'multilingual', 'budget'],
    bestFor: 'Lowest-cost multilingual transcription for bulk archives',
  },
  {
    id: 'gemini-3-1-pro-transcribe-google',
    provider: 'google',
    displayName: 'Gemini 3.1 Pro (Transcribe)',
    shortDescription: 'Latest Gemini flagship — top multimodal transcription, preview',
    ...
    speedTier: 'medium',
    priceTier: 'medium',
    providerCostUsdPerMinute: 0.0096,
    fiatPriceUsdPerMinute: withFiatMargin(0.0096),
    loarPriceUsdPerMinute: withLoarMargin(0.0096),
    creditCostPerMinute: usdToCredits(withFiatMargin(0.0096)),
    lastVerified: '2026-06-14',
    isEnabled: true,
    isVisibleToUsers: true,
    allowedPlans: [],
    serverPoolAvailable: true,
    tags: ['transcribe', 'google', 'gemini', '3.1', 'multilingual', 'diarize', 'preview'],
    bestFor: 'Best-available transcription quality on the newest Gemini',
  },
];
