...
export const API_KEY_SCOPES = {
  ...
  'generation.audio': 'Generate audio / music (costs credits)',
  'generation.lipsync': 'Generate lip-sync / talking scenes (costs credits)',
  'generation.create': 'General content generation (costs credits)',
