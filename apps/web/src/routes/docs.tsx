...
└── docker-compose.yml`}</CodeBlock>
  ...
  │
  ├─► Frontend (React + Wagmi) ──► Wallet (Circle DCW)
  │     │                                    │
        ...
        └─► LoarHook (Uniswap v4)`}</CodeBlock>
            ...
            <Table
              ...
              rows={[
                [
                  'Frontend',
                  'React 18, Vite 6, TailwindCSS v4, TanStack Router/Query, Wagmi, Circle DCW',
                ],
          ...
          <Section id="frontend" title="Frontend (apps/web)" icon={Globe}>
            ...
            <Table
              ...
              rows={[
                ...
                ['/login', 'LoginPage', 'Circle DCW email/social sign-in with SIWE session'],
                [
                  '/dashboard',
                  'Dashboard',
            ...
            <Table
              ...
              rows={[
                ...
                ['WalletConnectButton', 'Circle DCW sign-in / session widget'],
              ]}
            />
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>
                ...
                <Code>useWalletAuth()</Code> hook backed by Circle DCW + SIWE
              </li>
            </ul>
          </Section>
