  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <button
        ...
        className="fixed right-4 z-40 w-12 h-12 rounded-full bg-primary text-white shadow-lg shadow-primary/30 flex items-center justify-center active:scale-95 transition-transform md:hidden"
