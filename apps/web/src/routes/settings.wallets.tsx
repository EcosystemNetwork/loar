/**
 * /settings/wallets — Show the user's LOAR EVM wallet.
 *
 * Every authenticated user has a Circle DCW EVM wallet (their primary session
 * identity). No external wallet adapter or sign-link flow is required.
 */
    ...
    <div className="container mx-auto max-w-2xl space-y-6 py-8">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          One LOAR identity on Ethereum. Your wallet is provisioned automatically and signed
