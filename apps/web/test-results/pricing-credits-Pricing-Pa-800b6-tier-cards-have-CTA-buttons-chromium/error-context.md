...
- Name: pricing-credits.spec.ts >> Pricing Page — Tier Cards >> tier cards have CTA buttons
- Location: e2e/pricing-credits.spec.ts:99:3
...
Expected pattern: /pay with.*loar|current plan|subscribe|get started/i
Received string:  "
