...
- Name: smoke.spec.ts >> Partial features redirect to Coming Soon >> /sell redirects to coming-soon
...
Received string:  "http://localhost:3001/sell"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    13 × unexpected value "http://localhost:3001/sell"
