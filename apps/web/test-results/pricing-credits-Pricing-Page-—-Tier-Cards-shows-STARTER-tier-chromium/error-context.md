...
- Name: pricing-credits.spec.ts >> Pricing Page — Tier Cards >> shows STARTER tier
- Location: e2e/pricing-credits.spec.ts:68:3
...
Locator: getByText(/starter/i).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/starter/i).first()
