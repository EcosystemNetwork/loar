...
- Name: pricing-credits.spec.ts >> Pricing Page — Tier Cards >> shows "Most Popular" badge on one tier
- Location: e2e/pricing-credits.spec.ts:88:3
...
Locator: getByText(/most popular/i).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/most popular/i).first()
