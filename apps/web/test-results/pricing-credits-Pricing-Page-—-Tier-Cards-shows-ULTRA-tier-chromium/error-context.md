...
- Name: pricing-credits.spec.ts >> Pricing Page — Tier Cards >> shows ULTRA tier
- Location: e2e/pricing-credits.spec.ts:78:3
...
Locator: getByText(/ultra/i).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/ultra/i).first()
