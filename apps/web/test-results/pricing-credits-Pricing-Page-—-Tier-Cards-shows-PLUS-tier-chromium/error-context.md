...
- Name: pricing-credits.spec.ts >> Pricing Page — Tier Cards >> shows PLUS tier
- Location: e2e/pricing-credits.spec.ts:73:3
...
Locator: getByText(/plus/i).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/plus/i).first()
