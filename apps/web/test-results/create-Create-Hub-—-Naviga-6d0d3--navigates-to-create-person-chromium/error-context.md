...
- Name: create.spec.ts >> Create Hub — Navigation to Forms >> clicking Person card navigates to /create/person
- Location: e2e/create.spec.ts:65:3
...
Expected pattern: /\/create\/person/
Received string:  "http://localhost:3001/login?redirect=%2Fcreate%2Fperson"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    14 × unexpected value "http://localhost:3001/login?redirect=%2Fcreate%2Fperson"
